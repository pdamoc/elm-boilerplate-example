...
var _user$project$WithParts$rightAlignedDiv = function (item) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$WithParts$phone = _debois$elm_mdl$Material_Grid$size(_debois$elm_mdl$Material_Grid$Phone);
var _user$project$WithParts$tablet = _debois$elm_mdl$Material_Grid$size(_debois$elm_mdl$Material_Grid$Tablet);
var _user$project$WithParts$desktop = _debois$elm_mdl$Material_Grid$size(_debois$elm_mdl$Material_Grid$Desktop);
var _user$project$WithParts$fullRow = function (w) {
	return A2(
		_debois$elm_mdl$Material_Grid$cell,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$WithParts$desktop(12),
				_user$project$WithParts$tablet(8),
				_user$project$WithParts$phone(4),
				_debois$elm_mdl$Material_Grid$align(_debois$elm_mdl$Material_Grid$Middle)
			]),
		_elm_lang$core$Native_List.fromArray(
			[w]));
};
var _user$project$WithParts$halfRow = function (w) {
	return A2(
		_debois$elm_mdl$Material_Grid$cell,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$WithParts$desktop(6),
				_user$project$WithParts$tablet(4),
				_user$project$WithParts$phone(4)
			]),
		_elm_lang$core$Native_List.fromArray(
			[w]));
};
var _user$project$WithParts$all = _debois$elm_mdl$Material_Grid$size(_debois$elm_mdl$Material_Grid$All);
var _user$project$WithParts$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$WithParts$updateUser = F2(
	function (msg, user) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'FullName':
...
var _user$project$WithParts$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'UserDataChanged':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							userData: A2(_user$project$WithParts$updateUser, _p1._0, model.userData)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Submit':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							submitedData: _elm_lang$core$Basics$toString(model.userData)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Noop':
...
var _user$project$WithParts$emptyUserData = {fullName: '', company: '', email: '', phone: '', addressLine1: '', addressLine2: '', city: '', state: '', country: '', premium: false};
var _user$project$WithParts$UserData = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$WithParts$Model = F3(
	function (a, b, c) {
		return {userData: a, submitedData: b, mdl: c};
	});
var _user$project$WithParts$init = {
	ctor: '_Tuple2',
	_0: A3(_user$project$WithParts$Model, _user$project$WithParts$emptyUserData, '', _debois$elm_mdl$Material$model),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$WithParts$Premium = {ctor: 'Premium'};
var _user$project$WithParts$Country = function (a) {
	return {ctor: 'Country', _0: a};
};
var _user$project$WithParts$State = function (a) {
	return {ctor: 'State', _0: a};
};
var _user$project$WithParts$City = function (a) {
	return {ctor: 'City', _0: a};
};
var _user$project$WithParts$AddressLine2 = function (a) {
	return {ctor: 'AddressLine2', _0: a};
};
var _user$project$WithParts$AddressLine1 = function (a) {
	return {ctor: 'AddressLine1', _0: a};
};
var _user$project$WithParts$Telephone = function (a) {
	return {ctor: 'Telephone', _0: a};
};
var _user$project$WithParts$Email = function (a) {
	return {ctor: 'Email', _0: a};
};
var _user$project$WithParts$Company = function (a) {
	return {ctor: 'Company', _0: a};
};
var _user$project$WithParts$FullName = function (a) {
	return {ctor: 'FullName', _0: a};
};
var _user$project$WithParts$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$WithParts$Noop = {ctor: 'Noop'};
var _user$project$WithParts$Submit = {ctor: 'Submit'};
var _user$project$WithParts$UserDataChanged = function (a) {
	return {ctor: 'UserDataChanged', _0: a};
};
var _user$project$WithParts$view = function (model) {
	var submit = A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$WithParts$Mdl,
		_elm_lang$core$Native_List.fromArray(
			[11]),
		model.mdl,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_debois$elm_mdl$Material_Button$onClick(_user$project$WithParts$Submit)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
			...
			return A4(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						function (_p2) {
							return _user$project$WithParts$UserDataChanged(
								msg(_p2));
						}),
	...
	var fullName = A4(
		...
		'Full Name',
		user.fullName,
		_user$project$WithParts$FullName);
	var company = A4(
		textField,
		_elm_lang$core$Native_List.fromArray(
			[2]),
		'Company',
		user.company,
		_user$project$WithParts$Company);
	var email = A4(
		textField,
		_elm_lang$core$Native_List.fromArray(
			[3]),
	...
	var phone = A4(
		...
		'Phone',
		user.phone,
		_user$project$WithParts$Telephone);
	var addressLine1 = A4(
		textField,
		_elm_lang$core$Native_List.fromArray(
			[5]),
		'Address Line One',
		user.addressLine1,
		_user$project$WithParts$AddressLine1);
	var addressLine2 = A4(
		textField,
		_elm_lang$core$Native_List.fromArray(
			[6]),
		'Address Line Two',
		user.addressLine2,
		_user$project$WithParts$AddressLine2);
	var city = A4(
		textField,
		_elm_lang$core$Native_List.fromArray(
			[7]),
	...
	var country = A4(
		...
		'Country',
		user.country,
		_user$project$WithParts$Country);
	var premium = A5(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$WithParts$UserDataChanged(_user$project$WithParts$Premium)),
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_user$project$WithParts$fullRow(fullName),
										_user$project$WithParts$fullRow(company),
										_user$project$WithParts$halfRow(email),
										_user$project$WithParts$halfRow(phone),
										_user$project$WithParts$fullRow(addressLine1),
										_user$project$WithParts$fullRow(addressLine2),
										_user$project$WithParts$halfRow(city),
										_user$project$WithParts$halfRow(state),
										_user$project$WithParts$fullRow(country),
										_user$project$WithParts$fullRow(premium),
										_user$project$WithParts$fullRow(
										A2(
											...
											_elm_lang$core$Native_List.fromArray(
												[]))),
										_user$project$WithParts$fullRow(
										_user$project$WithParts$rightAlignedDiv(submit))
									]))
							]))
					])),
				A2(
...
var _user$project$WithParts$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$WithParts$init, update: _user$project$WithParts$update, view: _user$project$WithParts$view, subscriptions: _user$project$WithParts$subscriptions})
};

var Elm = {};
Elm['WithParts'] = Elm['WithParts'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['WithParts'], 'WithParts', typeof _user$project$WithParts$main === 'undefined' ? null : _user$project$WithParts$main);
